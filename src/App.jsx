...
function printOrder(order) {
  ...
  try {
    ...
    // Imprime 2 exemplaires (un pour le client, un pour la cuisine),
    // avec une petite pause entre les deux pour laisser le temps à la
    // connexion Bluetooth de se libérer avant la deuxième impression.
    // (Compatible avec l'ancienne appli Android, sans le paramètre "copies".)
    window.AndroidPrinter.printTicket(payload);
    setTimeout(() => {
      window.AndroidPrinter.printTicket(payload);
    }, 2500);
  } catch (e) {
