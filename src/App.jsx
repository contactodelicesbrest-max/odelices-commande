  ...
  return (
    <div className="modal-backdrop" onClick={onClose}>
      <div className="modal" onClick={(e) => e.stopPropagation()}>
        ...
        {(meatRequired > 0 || (extraMeatPrice > 0 && meatOptions.length > 0)) && (
          <div className="modal-section">
            <span className="modal-label">
              {meatRequired > 0 && extraMeatPrice > 0
                ...
                : `Viande supplémentaire (+${money(extraMeatPrice)} par viande) — ${meats.length} sélectionnée${meats.length > 1 ? "s" : ""}`}
            </span>
