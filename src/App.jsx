...
function buildTicketSegments(order) {
  ...
  push("--------------------------------");
  push(`Client : ${order.clientName || "-"}`, { bold: true, tall: true });
...
function ClientView() {
  ...
  if (step === "payment") {
    ...
    const canSubmit = nameValid && emailValid && (changeDue === null || changeDue >= 0);
    ...
    return (
      <div className="screen">
        ...
        <div className="modal-section">
          <span className="modal-label">Ton prénom (obligatoire)</span>
          <input
            className="input"
            type="text"
        ...
        <div className="modal-section">
          ...
          />
          {!emailValid && <p className="track-error">Adresse email invalide.</p>}
        </div>
